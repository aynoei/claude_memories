...
- **Importante:** o conector precisa expor ferramentas de conteudo, nao
  ...
  **Ao conectar o Google Drive, habilite os dois grupos de permissao:**
  "Ferramentas somente leitura" e "Ferramentas de gravação/exclusão" —
  marque "Sempre permitir" nos dois. Se apenas um grupo for autorizado,
  parte dos comandos falha silenciosamente (ex: consegue ler mas nao
  consegue criar registro, ou vice-versa). Isso vale tanto para quem cria
  a memoria (dono) quanto para quem conecta a uma memoria compartilhada
  (consumidor).
